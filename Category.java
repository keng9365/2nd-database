...
public class Category extends javax.swing.JFrame {
    ...
    private void clickTable() {
        try {
            ...
            String sql = "select * from category where cat_id = '" + selectId + "' ";
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                String add1 = rs.getNString("cat_id");
                txt_id.setText(add1);
                String add2 = rs.getNString("cat_name");
    ...
    private void insertData() {
        try {
            String sql = "insert into category(cat_id, cat_name) "
                    + "values(?,?)";
            pst = con.prepareStatement(sql);
    ...
    private void updateData() {
        try {
            String sql = "UPDATE category SET cat_id = ? ,cat_name = ? "
                    + "WHERE cat_id = '" + txt_id.getText() + "'";
            pst = con.prepareStatement(sql);
            pst.setString(1, txt_id.getText());
            pst.setString(2, txt_name.getText());
            pst.execute();
    ...
    private void deleteData() {
        try {
            ...
            String sql = "DELETE FROM category WHERE cat_id = '" + id_delete + "'";
            pst = con.prepareStatement(sql);
            pst.executeUpdate();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (type.equalsIgnoreCase(txt_id.getText())) {
                    JOptionPane.showMessageDialog(this, "Category ID is duplicate!", "fail!", JOptionPane.OK_OPTION);
                    txt_id.setText("");
                }
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(183, 231, 255));
